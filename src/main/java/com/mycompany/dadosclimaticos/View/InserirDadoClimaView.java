 ...
 * @author chris
 */
public class InserirDadoClimaView extends javax.swing.JInternalFrame {
    /**
     * Creates new form EstatisticaClimaView
     */
    public InserirDadoClimaView(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconable) {
    ...
    private void initComponents() {
        ...
        buttonIncluir.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
